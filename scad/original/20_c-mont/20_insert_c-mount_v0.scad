...
module CmountInsert(insert_height=5, tube_height=5, thread_len=5, wall=2) {
    difference() {
        translate([0,0,insert_height/2]) CubeInsert(insert_height);
        cylinder(r=13-wall, h=insert_height);
        }
    translate([0, 0, insert_height])
    difference() {
        cylinder(r=13, h=tube_height);
        cylinder(r=13-wall, h=tube_height);
        }
    translate([0, 0, insert_height+tube_height])
        difference() {
...
CmountInsert(insert_height=25, tube_height=15);